...
\begin{noheadline}
    \begin{frame}
        ...
        \begin{columns}
            ...
            \hspace*{2em}
            \includegraphics[scale=.28]{images/tree-light.png}
        \end{columns}
    \end{frame}
\end{noheadline}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Kako organizirate svoje projekte?

        \item Kako dijelite materijale sa suradnicima i kolegama?

        \item Gdje pohranjujete podatke za vrijeme trajanja projekta?
